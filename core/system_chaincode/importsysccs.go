...
import (
	...
	"github.com/hyperledger/fabric/core/system_chaincode/utxo"
)
...
func RegisterSysCCs() {
	...
	api.RegisterSysCC("github.com/hyperledger/fabric/core/system_chaincode/utxo", &utxo.SystemChaincode{})
}
